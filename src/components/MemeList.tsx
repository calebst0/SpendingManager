			...
			<div className="container meme-list-wrapper">
                <div className="row meme-list-heading">
                    <div className="input-group">
                        <div className="col-8 font-weight-bold mt-1">TRANSACTIONS TABLE</div>
                        <input type="text" id="search-tag-textbox" className="form-control col-4" placeholder="Search By Tags" />
